    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent  = new Intent(blackCat.this,MainActivity.class);
        ...
        flch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent  = new Intent(blackCat.this,horror.class);
                startActivity(intent);
            }
        });
        ...
        down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://www.ibiblio.org/ebooks/Poe/Black_Cat.pdf";
                ...
                Toast.makeText(blackCat.this, "download started", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        pdfView.fromAsset("blackcat.pdf").load();
    }
}