...
public class land extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent  = new Intent(land.this,science.class);
                startActivity(intent);
            }
        });
        ...
        down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://www.arvindguptatoys.com/arvindgupta/land-time%20forgot.pdf";
                ...
                Toast.makeText(land.this, "download started", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        pdfView.fromAsset("land.pdf").load();
    }
}